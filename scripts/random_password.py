...
def generate_password():
    ...
    include_uppercase = input("Do you need uppercase letters? (yes/no): ").strip().lower()
    include_special = input("Do you need special characters? (yes/no): ").strip().lower()
    include_digits = input("Do you need digits? (yes/no): ").strip().lower()
